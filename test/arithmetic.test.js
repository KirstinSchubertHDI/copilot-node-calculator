describe("Arithmetic", function () {
  ...
  describe("Subtraction", function () {
    ...
    it("subtracts zero from an integer", function (done) {
      request
        .get("/arithmetic?operation=subtract&operand1=42&operand2=0")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 42 });
          done();
    ...
    it("subtracts an integer from a floating point number", function (done) {
      request
        .get("/arithmetic?operation=subtract&operand1=2.5&operand2=-5")
        .expect(200)
        .end(function (err, res) {
    ...
    it("subtracts with negative exponent", function (done) {
      request
        .get("/arithmetic?operation=subtract&operand1=1.2e-5&operand2=-1.2e-5")
        .expect(200)
        .end(function (err, res) {
  ...
  describe("Power", function () {
    ...
    it("powers zero by a positive integer", function (done) {
      request
        .get("/arithmetic?operation=power&operand1=0&operand2=2")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 0 });
          done();
    ...
    it("powers a positive integer by zero", function (done) {
      request
        .get("/arithmetic?operation=power&operand1=2&operand2=0")
        .expect(200)
        .end(function (err, res) {
  ...
  describe("Square Root", function () {
    it("square roots a positive integer", function (done) {
      request
        .get("/arithmetic?operation=sqrt&operand1=4")
        .expect(200)
        .end(function (err, res) {
    ...
    it("square roots zero", function (done) {
      request
        .get("/arithmetic?operation=sqrt&operand1=0")
        .expect(200)
        .end(function (err, res) {
          expect(res.body).to.eql({ result: 0 });
          done();
    ...
    it("square roots a negative integer", function (done) {
      request
        .get("/arithmetic?operation=sqrt&operand1=-4")
        .expect(200)
        .end(function (err, res) {
